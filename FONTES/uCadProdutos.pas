...
type
  TfrmCadProdutos = class(TForm)
    ...
    dbedtNCM: TDBEdit;
    Label8: TLabel;
    dblcmbCfop: TDBLookupComboBox;
    Label9: TLabel;
    dtsCFOP: TDataSource;
    dblcmbSituacaoTributaria: TDBLookupComboBox;
    Label10: TLabel;
    dtsSituacaoTributaria: TDataSource;
...
begin
  ...
  begin
    Application.MessageBox(' Campo descrição do produto e obrigatório.'#13,
  ...
  begin
    Application.MessageBox(' Campo preço de custo e obrigatório.'#13,
        ' Atenção', MB_OK + MB_ICONINFORMATION);
  ...
  begin
    Application.MessageBox(' Campo preço de venda e obrigatório.'#13,
        ' Atenção ', MB_OK + MB_ICONINFORMATION);
  ...
  begin
    Application.MessageBox(' Campo estoque mínimo e obrigatório.'#13,
        ' Atenção ', MB_OK + MB_ICONINFORMATION);
...
begin
  ...
  DMPRINCIPAL.cdsSituacaoTributaria.open;
end;
end.
